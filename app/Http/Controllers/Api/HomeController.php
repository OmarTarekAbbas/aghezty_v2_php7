...
class HomeController extends Controller
{
    ...
    public function addresses(Request $request)
    {
        ...
        $addresses = ClientAddress::where('client_id', $client->id)
                    ...
                    ->select('client_addresses.id','client_addresses.address','cities.id as city_id','governorates.id as gover_id','cities.city_en', 'cities.city_ar','governorates.title_en as governorate_en', 'governorates.title_ar as governorate_ar')
                    ->get();
