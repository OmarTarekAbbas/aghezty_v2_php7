    ...
    <div class="mobile_views">
      <div class="choose_category_background">
        <div class="row mr-0 ml-0">
          ...
          <div class="col-md-2 col-xl-2 col-4 margin_bottom_mob">
            <div class="choose_category_form text-center">
              <a href="{{route('front.home.list',['ifrom_ito' => '0,21','search' => 'TV'])}}">
          ...
          <div class="col-md-2 col-xl-2 col-4 margin_bottom_mob">
            <div class="choose_category_form text-center">
              <a href="{{route('front.home.list',['ifrom_ito' => '33,42','search' => 'TV'])}}">
          ...
          <div class="col-md-2 col-xl-2 col-4 margin_bottom_mob">
            <div class="choose_category_form text-center">
              <a href="{{route('front.home.list',['ifrom_ito' => '43,54','search' => 'TV'])}}">
          ...
          <div class="col-md-2 col-xl-2 col-4 margin_bottom_mob">
            <div class="choose_category_form text-center">
              <a href="{{route('front.home.list',['ifrom_ito' => '55,65','search' => 'TV'])}}">
