                ...
                <div class="carousel-item {{$key == 0 ?'active' : ''}}">
                  <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                    <a class="zoom_image" href="{{url($image->image)}}">
                      <img class="m-auto d-block text-center" width="500px" height="{{$product->category->id == 17 ? '600px' : '400px'}}" src="{{url($image->image)}}" alt="{{$product->getTranslation('title',getCode())}}" />
                    </a>
                  </div>
                </div>
                @endforeach
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 col-12 mb-3">
        <div class="content_view hvr-bob px-2 h-100 bg-white rounded">
          <a href="{{route('front.home.inner',['id' => $item->id])}}">
            <img src="{{url($item->main_image)}}" width="{{($product->category->id == 34 && $product->brand_id == 6) ? 260:260}}" height="220" alt="Product" class="based_selection_img">
