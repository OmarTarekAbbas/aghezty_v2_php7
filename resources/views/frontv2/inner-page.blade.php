        ...
        <div class="row">
          ...
          <div class="features col-md-12">
            ...
            <div>
              ...
              <p class="d-inline-block px-1">{{$product->stock ? __('front.inner.in_stock') : ('front.inner.not_stock') }}</p>
            </div>
            ...
            <p class="quantity">@lang('front.inner.only')
              <span class="text-primary font-weight-bold">{{$product->stock}}</span> @lang('front.inner.reset')
            </p>
          </div>
          ...
          <div class="col-md-12 padding_right_mob">
            <form class="quantity-form">
              ...
              <button type="button" class="btn float-left font-weight-bold text-capitalize hvr-wobble-to-bottom-right" id="notify_me" data-toggle="modal" data-target="#notify_me_modal">@lang('front.notify_me')</button>
            </form>
          </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title text-dark text-capitalize text-center w-100" id="exampleModalLabel">Notify me when available</h5>
              ...
              <form class="forms">
                <div class="form-row">
                  <div class="form-group col-md-6 col-lg-6 col-xl-6 col-12 text-dark">
                    <label for="inputEmail4">@lang('front.email') <em>*</em></label>
                    <input type="email" class="form-control hvr-float" id="inputEmail4" placeholder="@lang('front.email')">
                  </div>

                  <div class="form-group col-md-6 col-lg-6 col-xl-6 col-6 text-dark">
                    <label for="inputName4">@lang('front.name') <em>*</em></label>
                    <input type="text" class="form-control hvr-float" id="inputName4" placeholder="@lang('front.name')">
                  </div>

                  <div class="form-group col-md-4 col-lg-4 col-xl-4 col-6 text-dark">
                    <label for="inputPhone">@lang('front.phone') <em>*</em></label>
                    <input type="tel" class="form-control hvr-float" id="inputPhone" placeholder="@lang('front.phone')">
                  </div>

                  <div class="form-group col-md-4 col-lg-4 col-xl-4 col-6 text-dark">
                    <label for="inputGovernorate">@lang('front.governorate') <em>*</em></label>
                    <select id="inputGovernorate" class="form-control hvr-float">
                      <option selected>@lang('front.governorate')</option>
                      <option>...</option>
                    </select>
                  </div>

                  <div class="form-group col-md-4 col-lg-4 col-xl-4 col-6 text-dark">
                    <label for="inputCity">@lang('front.city') <em>*</em></label>
                    <select id="inputCity" class="form-control hvr-float">
                      <option selected>@lang('front.city')</option>
                      <option>...</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-md-12 col-lg-12 col-xl-12 col-12">
                    <div class="model_send my-3 hvr-float">
                      <button type="button" class="btn w-100">@lang('front.send')</button>
                    </div>
                  </div>
                </div>
              </form>
          ...
          <div class="content_view hvr-bob px-2 h-100 bg-white rounded">
            ...
            <div class="price-box">
              <span class="regular-price">
                <span class="price font-weight-bold">{{($item->discount > 0)?$item->price_after_discount:$item->price}}
                  @lang('front.egp') </span>
              </span>
              @if($item->discount > 0)
              <p class="old-price">
      ...
      <div class="row mt-5">
        ...
        <div class="col-md-6">
          <div class="review_title">
            <h4 class="text-capitalize d-inline-block" id="review_comment_title_typed">@lang('front.inner.reviews')</h4>
          </div>
          @foreach ($product->client_rates as $review)
          <div class="review-area my-3">
            <span class="review-by"> @lang('front.inner.review_by') <strong>{{$review->name}} </strong> <span style="{{Session::get('applocale') =='en' ?'float:right;direction: ltr;':'float:left;direction: ltr;'}}"> {{ $review->pivot->created_at->format('d-m-Y h:m A') }} </span> </span>
        ...
        <div class="col-md-6" id="review">
          ...
          <p style="color: #777;">@lang('front.rate_product'){{Session::get('applocale') =='en' ? '?' : '؟'}} *</p>
