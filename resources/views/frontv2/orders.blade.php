        ...
        <div class="row m-0" style="min-height:400px">
          <div class="col-md-12 col-lg-12 col-xl-12 col-12">
            <div class="my_profile_title text-center my-3">
              <h5 class="text-capitalize text-white m-auto w-25 border-bottom border-secondary">
                @lang('front.my_order')
              </h5>
            ...
            <div class="accordion_add w-100 my-3" id="accordionExample_2">
              ...
              <div class="card z-depth-0 bordered">
                <div class="card-header" id="heading{{$key+1}}">
                  <h5 class="mb-0">
                    <button class="btn btn-link text-center w-100" type="button" data-toggle="collapse"
                      data-target="#collapse{{$key+1}}" aria-expanded="true" aria-controls="collapseFour">
                      @lang('front.order') {{$key+1}}
                    </button>
                  </h5>
                </div>

                <div id="collapse{{$key+1}}" class="collapse {{(!$key)? 'show' : ''}}"
                  aria-labelledby="heading{{$key+1}}" data-parent="#accordionExample_2">
                  <div class="card-body">
                          ...
                          <div class="summary w-100 p-3 my-3 border border-secondary bg-light text-dark">
                            ...
                            <div class="summary-subtotal">
                              <div class="subtotal-title text-left w-50 float-left">
                                @lang('front.total_price')</div>
                              <div class="subtotal-value text-right w-50 float-right">
                                {{number_format($order->total_price - $order->shipping_amount)}}
                              </div>
                            </div>
                            ...
                            <div class="summary-subtotal">
                              <div class="subtotal-title text-left w-50 float-left">
                                @lang('front.total_price_after_shipping')</div>
                              <div class="subtotal-value  text-right w-50 float-right ">
