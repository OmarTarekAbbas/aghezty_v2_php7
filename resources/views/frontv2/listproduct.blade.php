      ...
      <div id="toggle_plus_minus" class="col-md-2 col-lg-2 col-xl-2 d-none d-md-none d-lg-none d-xl-block">
        <form id="filter_form" method="post">
          ...
          <div class="panel brand_panel_change mb-3 w-100 border border-light">
            ...
            @if((request()->filled("brand_id") && request()->get("brand_id")  == $brand->id) || request()->filled("sub_category_id") || (request()->route("category_name") && session("coming_from") == 'category' )|| (request()->route("brand_id") && request()->route("brand_id")  == $brand->id) || request()->filled("offer") || request()->filled("most_solid") || request()->route("brands_name") == $brand->title)
            <div class="z-checkbox">
        ...
        <div id="grid_two" class="row mt-3 content_view_mobile">
          ...
          <div class="col-md-4 col-lg-4 col-xl-4 col-6 content_view_mobile_col6">
            <div class="content_view hvr-bob px-2 bg-white rounded">
              <a href="{{route('front.home.inner',['id' => $product->product_id ,'slug' => setSlug($product->getTranslation('title','en'))]) }}">
