                        ...
                        <div class="card-body">
                          <div class="col-md-12 col-lg-12 col-xl-12 col-12 px-0 mb-4">
                            <div class="input-group mb-2 m-auto w-75 hvr-float">
                              ...
                              {!! Form::select("governorate_id", $countrys->pluck('title_'.getCode(),'id'),$item->governorate->id, ['required','class' => 'form-control hvr-float gover_update']) !!}
                            </div>
                          </div>
                          ...
                          <div class="col-md-12 col-lg-12 col-xl-12 col-12 px-0 mb-4">
                            <div class="input-group mb-2 m-auto w-75 hvr-float">
                              ...
                              {!! Form::select("city_id", $citys->pluck('city_'.getCode(),'id'),$item->pivot->city_id , ['required' , 'class' => 'form-control hvr-float update_city']) !!}
                            </div>
                          </div>
                          ...
                          <div class="col-md-12 col-lg-12 col-xl-12 col-12 px-0 mb-4">
                            <div class="input-group mb-2 w-75 m-auto hvr-float">
                              <div class="input-group-prepend hvr-float">
                                ...
                                <textarea class="p-3 w-100 hvr-float" placeholder="@lang('front.my_address') {{$key+1}}" cols="150" rows="2" name="address">{{$item->pivot->address}}</textarea>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="col-md-12 col-lg-12 col-xl-12 col-12 px-0 mb-4">
                          <div class="input-group mb-2 m-auto w-75 hvr-float">
                            ...
                            {!! Form::select("governorate_id", $countrys->pluck('title_'.getCode(),'id'),null, ['required','class' => 'form-control hvr-float' ,'id' => 'gover_add']) !!}
                          </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 col-12 px-0 mb-4">
                          <div class="input-group mb-2 m-auto w-75 hvr-float">
                            ...
                            {!! Form::select("city_id", $citys->pluck('city_'.getCode(),'id'),null , ['required' , 'class' => 'form-control hvr-float' ,'id' => 'add_city']) !!}
                          </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 col-12 px-0 mb-4">
                          <div class="input-group mb-2 w-75 m-auto hvr-float">
                            <div class="input-group-prepend hvr-float">
                              <div class="input-group-text"><i class="fas fa-keyboard"></i></div>
                              <textarea class="p-3 w-100 hvr-float" placeholder="@lang('front.my_address')" cols="150" rows="2" name="address"></textarea>
                            </div>
                          </div>
                        </div>
