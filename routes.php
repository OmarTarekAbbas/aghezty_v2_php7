...
Route::get('governorate/create','GovernorateController@create');
Route::post('governorate','GovernorateController@store');
Route::get('governorate/{id}','GovernorateController@show');
Route::get('governorate/{id}/edit','GovernorateController@edit');
Route::patch('governorate/{id}','GovernorateController@update');
Route::get('governorate/{id}/delete','GovernorateController@delete');
...
Route::get('advertisement/{id}/delete','AdvertisementController@delete');
...
Route::get('coupon/{id}/delete','CouponController@destroy');
Route::get('order','OrderController@index');
Route::get('order/{id}','OrderController@show');
Route::get('order/{id}/delete','OrderController@delete');
Route::get('delete_order','OrderController@delete_product');
Route::post('orders/update_status','OrderController@update_status');
});
...
Route::get('setting/address','SettingController@add_address');
Route::get('products/get_excel','ProductController@get_excel');
Route::post('products/store_excel','ProductController@store_excel');
Route::get('product/downloadSampleNew','ProductController@getDownload');
Route::get('unavailable','ContactController@request_index');
Route::post('unavailable/{id}','ContactController@message_to_user');
...
Route::get('property/{id}/delete','PropertyController@destroy');
Route::get('property_value','PropertyValueController@index');
Route::get('property_value/create','PropertyValueController@create');
Route::post('property_value','PropertyValueController@store');
Route::get('property_value/{id}','PropertyValueController@show');
Route::get('property_value/{id}/edit','PropertyValueController@edit');
Route::patch('property_value/{id}','PropertyValueController@update');
Route::get('property_value/{id}/delete','PropertyValueController@destroy');
Route::get('reports','ReportIpController@index');
Route::get('most_sold_product','ReportIpController@most_sold_product');
Route::get('number_of_purchases','ReportIpController@number_of_purchases');
